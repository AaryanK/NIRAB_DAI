...
# 1. Open ROOT file and load Event 0
...
reco_fields = ["nTracks", "StartPos", "EndPos"]
reco_arr = t_reco.arrays(reco_fields, entry_start=event_id, entry_stop=event_id + 1)
...
lc_fields = ["nLinesU", "nLinesV", "TrackHitPosU", "TrackHitPosV"]
...
# --- Panel 1: 3D Event Display (StartPos to EndPos) ---
...
plt.suptitle(f"Amalgamated 2D/3D Event Display: Event {event_id}", fontsize=14, y=0.98)
plt.tight_layout()
