...
# Set project geometry constants
...
def main():
    ...
    # 2. Load the trained direct event-level regression models
    ...
    print("Loaded event-level models event_regressor_[x/y/z].joblib")

    # 3. Extract features for all active events and run inference
    ...
    for event_id in range(n_events):
        ...
        # Skip events with absolutely no tracks
        if n_u == 0 and n_v == 0:
        ...
        # Base geometric matching and PCA
    ...
    print("Reconstruction complete. Results saved to predicted_vertices_event_level.csv")
